...
void CFSniper::Precache( void )
{
	...
	m_iShell = PRECACHE_MODEL ("models/sniper_shell.mdl");	//model de la cartouche, éjectée dans la cl
	...
	m_usFSniper = PRECACHE_EVENT( 1, "events/fsniper.sc" );	//précache de l'évent pour la cartouche, le son, le décal ...
}
